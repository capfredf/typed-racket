...
[prop:custom-write (-struct-property (-> -Self -Output-Port (Un B (-val 1) (-val 0)) ManyUniv)
                                     #'custom-write?)]
[custom-write? (make-pred-ty (-has-struct-property (quote-syntax prop:custom-write)))]
[custom-write-accessor (-> (-has-struct-property (quote-syntax prop:custom-write))
...
[custom-print-quotable? (make-pred-ty (-has-struct-property (quote-syntax prop:custom-print-quotable)))]
[custom-print-quotable-accessor (-> (-has-struct-property (quote-syntax prop:custom-print-quotable))
                                    (Un (-val 'self)
                                        (-val 'never)
                                        (-val 'maybe)
                                        (-val 'always)))]
